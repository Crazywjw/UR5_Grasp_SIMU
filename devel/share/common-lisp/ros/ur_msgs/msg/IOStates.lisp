...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<IOStates>)))
  ...
  "b341cc0bc3ea976e9cacf81c26adeb88")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'IOStates)))
  "Returns md5sum for a message object of type 'IOStates"
  "b341cc0bc3ea976e9cacf81c26adeb88")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<IOStates>)))
  ...
  (cl:format cl:nil "Digital[] digital_in_states~%Digital[] digital_out_states~%Digital[] flag_states~%Analog[] analog_in_states~%Analog[] analog_out_states~%~%================================================================================~%MSG: ur_msgs/Digital~%uint8 pin~%bool state~%~%================================================================================~%MSG: ur_msgs/Analog~%uint8 CURRENT=0~%uint8 VOLTAGE=1~%~%uint8 pin~%uint8 domain # can be VOLTAGE or CURRENT~%float32 state~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'IOStates)))
  "Returns full string definition for message of type 'IOStates"
  (cl:format cl:nil "Digital[] digital_in_states~%Digital[] digital_out_states~%Digital[] flag_states~%Analog[] analog_in_states~%Analog[] analog_out_states~%~%================================================================================~%MSG: ur_msgs/Digital~%uint8 pin~%bool state~%~%================================================================================~%MSG: ur_msgs/Analog~%uint8 CURRENT=0~%uint8 VOLTAGE=1~%~%uint8 pin~%uint8 domain # can be VOLTAGE or CURRENT~%float32 state~%~%~%"))
