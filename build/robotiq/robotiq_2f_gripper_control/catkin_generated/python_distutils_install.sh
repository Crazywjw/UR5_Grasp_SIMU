...
echo_and_run cd "/home/jerry/ros_projects/Study/ur5_robot/src/robotiq/robotiq_2f_gripper_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/jerry/ros_projects/Study/ur5_robot/src/robotiq/robotiq_2f_gripper_control/setup.py" \
     \
    build --build-base "/home/jerry/ros_projects/Study/ur5_robot/build/robotiq/robotiq_2f_gripper_control" \
    install \
    --root="${DESTDIR-/}" \
