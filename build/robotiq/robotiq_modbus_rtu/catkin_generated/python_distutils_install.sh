...
echo_and_run cd "/home/jerry/ros_projects/Study/ur5_robot/src/robotiq/robotiq_modbus_rtu"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/jerry/ros_projects/Study/ur5_robot/src/robotiq/robotiq_modbus_rtu/setup.py" \
     \
    build --build-base "/home/jerry/ros_projects/Study/ur5_robot/build/robotiq/robotiq_modbus_rtu" \
    install \
    --root="${DESTDIR-/}" \
